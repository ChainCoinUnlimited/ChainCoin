...
1. Clone the Chaincoin source code:
    ```shell
...
## `disable-wallet` mode
When the intention is to run only a P2P node without a wallet, Chaincoin may be
...
## Running
Chaincoin is now available at `./src/chaincoind`
