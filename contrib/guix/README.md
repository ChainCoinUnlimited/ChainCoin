# Bootstrappable Chaincoin Core Builds

This directory contains the files necessary to perform bootstrappable Chaincoin
Core builds.
...
- 24GB of free disk space on the partition that the Chaincoin Core git repository
  resides in
...
For a Chaincoin Core depends development environment, simply invoke
...
From the top of a clean Chaincoin Core repository:
...
To use dongcarl's substitute server for Chaincoin Core builds after having
