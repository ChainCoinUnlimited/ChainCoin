...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-litemode=<n>", strprintf(_("Disable all Chaincoin specific functionality (Masternodes, CoinJoin, Funding) (0-1, default: %u)").translated, 0), false, OptionsCategory::OPTIONS);

    gArgs.AddArg("-masternode=<n>", strprintf(_("Enable the client to act as a masternode (0-1, default: %u)").translated, 0), false, OptionsCategory::OPTIONS);
    gArgs.AddArg("-mnconf=<file>", strprintf(_("Specify masternode configuration file (default: %s)").translated, "masternode.conf"), false, OptionsCategory::OPTIONS);
    gArgs.AddArg("-mnconflock=<n>", strprintf(_("Lock masternodes from masternode configuration file (default: %u)").translated, 1), false, OptionsCategory::OPTIONS);
    gArgs.AddArg("-masternodeprivkey=<n>", _("Set the masternode private key").translated, false, OptionsCategory::OPTIONS);
