...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-enableprivatesend=<n>", strprintf(_("Enable use of automated CoinJoin for funds stored in this wallet (0-1, default: %u)").translated, 0), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    gArgs.AddArg("-privatesendrounds=<n>", strprintf(_("Use N separate masternodes for each denominated input to mix funds (%u-%u, default: %u)").translated, MIN_COINJOIN_DEPTH, MAX_COINJOIN_DEPTH, DEFAULT_COINJOIN_DEPTH), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    gArgs.AddArg("-privatesendamount=<n>", strprintf(_("Keep N CHC anonymized (default: %u)").translated, DEFAULT_COINJOIN_AMOUNT), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
