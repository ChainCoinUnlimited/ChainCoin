...
static UniValue listsinceblock(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "  {                           (json object)\n"
            "    \"involvesWatchonly\" : xxx, (boolean) Only returns true if imported addresses were involved in transaction.\n"
            "    \"address\" : \"str\",        (string) The chaincoin address of the transaction.\n"
...
UniValue getaddressinfo(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "      DEPRECATED, will be removed in 0.21. To re-enable, launch chaincoind with `-deprecatedrpc=labelspurpose`:\n"
            "      {\n"
