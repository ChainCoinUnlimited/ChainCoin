    ...
    platformStyle(_platformStyle)
{
    ...
    this->setStyleSheet("WalletFrame { border:0px solid #000;border-image: url(':/images/walletFrame_bg') 0 0 0 0 stretch stretch;margin:0;padding-top:20px;padding-bottom: 20px; }");
