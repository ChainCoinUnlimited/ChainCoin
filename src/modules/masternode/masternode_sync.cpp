...
std::string CMasternodeSync::GetSyncStatus()
{
    switch (masternodeSync.nRequestedMasternodeAssets) {
        ...
        case MASTERNODE_SYNC_GOVERNANCE:    return _("Synchronizing funding objects...").translated;
...
{
    if (!fLiteMode) {
        scheduler.scheduleEvery(std::bind(&CMasternodeSync::ProcessTick, this, connman), std::chrono::milliseconds{1000});
    }
}
